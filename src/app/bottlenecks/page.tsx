...
export default function BottlenecksPage() {
  ...
  if (loading) {
    return (
      <div className="container mx-auto px-4 py-24 flex flex-col items-center justify-center">
        ...
        <p className="text-gray-400">Detecting bottlenecks...</p>
      </div>
    );
  }
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      >
        <h1 className="text-3xl font-bold gradient-text mb-2">Bottleneck Detection</h1>
        <p className="text-gray-400 mb-6">
          Automatic analysis of your pipeline for performance issues and optimization opportunities.
        </p>

        <BottleneckPanel suggestions={suggestions} />
      </motion.div>
    </div>
  );
}
